...
class TestExampleOne(FirefoxTestCase):
    ...
    def test_back_forward(self):
        ...
        # Navigation can be synthesized with self.marionette.navigate(<url>), and the url of
        # the current page can be accessed from self.marionette.get_url.

        # The navbar library (http://firefox-puppeteer.readthedocs.org/en/latest/ui/toolbars.html)
        ...
        # calling on the navbar and interacting with elements returned from it requires
        # chrome scope. To switch between scopes, use self.marionette.set_context('chrome')
        # or self.marionette.set_context('content'), or use a with block:
    ...
    def test_new_tab(self):
        ...
        # The tabs library has everything needed for this test.
    ...
    def test_new_tab_pref(self):
        ...
        # Use the value of the urlbar to verify the destination url, and close the newly opened
        # tab after doing so.
        pass

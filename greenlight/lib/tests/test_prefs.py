...
class TestPreferences(FirefoxTestCase):
    ...
    def test_clear_user_pref(self):
        ...
        self.assertTrue(self.prefs.clear_user_pref(self.string_pref))
        self.assertNotEqual(self.prefs.get_pref(self.string_pref), 'unittest')

        # There is no such preference anymore
        self.assertFalse(self.prefs.clear_user_pref(self.string_pref))
    ...
    def test_restore_pref(self):
        ...
        # Test with multiple set_pref call
        self.prefs.set_pref(self.string_pref, 'unittest')
